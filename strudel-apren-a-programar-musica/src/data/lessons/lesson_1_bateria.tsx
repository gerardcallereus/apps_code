      ...
      <div className="space-y-5">
        ...
        <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm">
          <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-3 font-display flex gap-2 items-center">
            🥁 Els Sons de la Bateria a l'Aon
          </h3>
          <p className="text-sm text-slate-600 mb-4 font-medium leading-relaxed">
            Per reproduir sons a l'Aon, fem servir la funció <code className="bg-slate-100 text-rose-600 px-1.5 py-0.5 rounded-md font-mono text-[13px] border border-slate-200">so()</code> (de <em>so</em>). A dins de les cometes escriurem les paraules de la bateria que volem que sonin seqüencialment:
          </p>
        ...
        <p className="text-slate-700 font-medium leading-relaxed">
          A l'Aon, el temps es divideix en <strong>cicles</strong> (compassos). Les síl·labes que escriguis es repartiran el temps d'un cicle de manera totalment equitativa. Prova aquests patrons clàssics de rap clicant a sobre d'ells per carregar-los a l'editor i fer-los sonar:
        </p>
