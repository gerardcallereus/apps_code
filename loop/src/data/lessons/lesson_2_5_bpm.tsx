      ...
      <div className="space-y-5">
        ...
        <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm">
          <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-3 font-display flex gap-2 items-center">
            ⏱️ Com configurar el tempo a LOOP
          </h3>
          <p className="text-sm text-slate-600 mb-4 font-medium leading-relaxed">
            Per indicar la velocitat a LOOP, escrivim la funció <code className="bg-slate-100 text-rose-600 px-1.5 py-0.5 rounded-md font-mono text-[13px] border border-slate-200">bpm(velocitat)</code> a dalt de tot del codi:
          </p>
