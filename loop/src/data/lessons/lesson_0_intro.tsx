...
export const lesson_0_intro: Lesson = {
    ...
    content: () => (
      <div className="space-y-4">
        <h2 className="text-3xl font-display font-bold text-slate-800 tracking-tight">Benvingut/da a l'Estudi de Rap de LOOP</h2>
        <p className="text-lg text-slate-600 font-medium leading-relaxed">
          LOOP és una eina dissenyada per ajudar-te a crear les teves pròpies <strong>bases de rap i hip-hop</strong> escrivint codi (el que anomenem <em>Live Coding</em>).
        </p>
        ...
        <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-100/50 shadow-sm shadow-indigo-100/30">
          <h3 className="text-xs font-bold text-indigo-500 uppercase tracking-wider mb-2 font-display flex gap-2 items-center">🎧 Escolta el potencial de LOOP:</h3>
