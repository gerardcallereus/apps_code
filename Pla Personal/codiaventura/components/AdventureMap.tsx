        ...
        >
            ...
            <form onSubmit={handleCodeSubmit} className="flex gap-3">
                <input 
                    ...
                    className="flex-1 bg-slate-100 border-4 border-black p-3 font-mono text-center tracking-[0.2em] font-bold uppercase focus:outline-none focus:bg-white text-[12px]"
                />
                <motion.button 
