      ...
      <div className="space-y-5">
        ...
        <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm">
          ...
          <p className="text-sm text-slate-600 mb-4 font-medium leading-relaxed">
            Quan tanquem diverses paraules dins d'uns corxets <code className="bg-slate-100 font-mono text-[13px] px-1 rounded">[ ]</code>, el motor de LOOP les tractarà com si fossin una sola posició en el temps, dividint-la equitativament entre elles. 
          </p>
